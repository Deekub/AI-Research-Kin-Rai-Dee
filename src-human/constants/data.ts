...
export const categories = ['เส้น', 'ข้าว', 'แกง', 'ต้ม', 'ยำ', 'ฟาสต์ฟู้ด'];
...
export const foodData: FoodItem[] = [
  ...
  // --- Soup ---
  { id: '16', name: 'ต้มยำกุ้ง', category: 'ต้ม', image: require('../assets/food/TomYum.jpg') },
  { id: '17', name: 'ต้มข่าไก่', category: 'ต้ม', image: require('../assets/food/TomKha.jpg') },
  { id: '18', name: 'แกงจืดเต้าหู้หมูสับ', category: 'ต้ม', image: require('../assets/food/ClearSoup.jpg') },
  { id: '19', name: 'ต้มเล้งแซ่บ', category: 'ต้ม', image: require('../assets/food/SpicyPorkBone.jpg') },
  { id: '20', name: 'ต้มแซ่บกระดูกอ่อน', category: 'ต้ม', image: require('../assets/food/TomSaap.jpg') },

  // --- Salad ---
  { id: '21', name: 'ส้มตำไทย', category: 'ยำ', image: require('../assets/food/SomTum.jpg') },
  { id: '22', name: 'สุกี้น้ำ', category: 'ยำ', image: require('../assets/food/SukiNam.jpg') },
  { id: '23', name: 'ยำวุ้นเส้น', category: 'ยำ', image: require('../assets/food/SpicySalad.jpg') },
  { id: '24', name: 'สลัดโรล', category: 'ยำ', image: require('../assets/food/SaladRoll.jpg') },
  { id: '25', name: 'ปลาเผา/นึ่งมะนาว', category: 'ยำ', image: require('../assets/food/SteamedFish.jpg') },
